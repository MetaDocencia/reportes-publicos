---
title: "ALTa Ciencia Abierta (Latin American contextualization of NASA's Open Science 101 course)"
---
...
A `r n_educ$por[5]`% (n = `r n_educ$n[5]`) has completed a graduate degree, `r n_educ$por[4]`% (n = `r n_educ$n[4]`) completed some graduate courses, `r n_educ$por[4]`% (n = `r n_educ$n[4]`) completed an undergraduate degree, `r sum(n_educ$por[3])`% (n = `r sum(n_educ$n[3])`) has taken or is currently taking undergraduate courses and `r n_educ$por[1]`% (n = `r n_educ$n[1]`) completed high school.
